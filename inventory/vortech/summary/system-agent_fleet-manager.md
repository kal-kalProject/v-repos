...
repo: vortech
package_name: "@system-agent/fleet-manager"
package_path: "system-agent/fleet-manager"
language: ts
...
# @system-agent/fleet-manager

## 1. Identidad
- **Nombre:** @system-agent/fleet-manager
- **Path:** `system-agent/fleet-manager`
- **Lenguaje:** ts
...
**Evidencia:**
- `system-agent/fleet-manager/src/main.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `system-agent/fleet-manager`.
