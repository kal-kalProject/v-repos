...
repo: vortech
package_name: "@vortech/wire"
package_path: "packages/wire"
language: ts
...
**Evidencia:**
- `packages/wire/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/wire`.
