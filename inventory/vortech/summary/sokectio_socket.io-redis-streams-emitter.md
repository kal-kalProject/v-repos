...
repo: vortech
package_name: "@socket.io/redis-streams-emitter"
package_path: "sokectio/socket.io-redis-streams-emitter"
language: ts
...
## 1. Identidad
- **Nombre:** @socket.io/redis-streams-emitter
- **Path:** `sokectio/socket.io-redis-streams-emitter`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/socket.io-redis-streams-emitter/lib/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io-redis-streams-emitter`.
