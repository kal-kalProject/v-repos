...
repo: vortech
package_name: "@vortech/datasources"
package_path: "packages/datasources"
language: ts
...
## 1. Identidad
- **Nombre:** @vortech/datasources
- **Path:** `packages/datasources`
- **Lenguaje:** ts
...
**Evidencia:**
- `packages/datasources/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/datasources`.
