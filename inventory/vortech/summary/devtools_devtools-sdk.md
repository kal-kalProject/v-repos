...
repo: vortech
package_name: "@vortech/devtools-sdk"
package_path: "devtools/devtools-sdk"
language: ts
...
# @vortech/devtools-sdk

## 1. Identidad
- **Nombre:** @vortech/devtools-sdk
- **Path:** `devtools/devtools-sdk`
- **Lenguaje:** ts
...
**Evidencia:**
- `devtools/devtools-sdk/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `devtools/devtools-sdk`.
