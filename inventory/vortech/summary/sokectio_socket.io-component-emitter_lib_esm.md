...
package_path: "sokectio/socket.io-component-emitter/lib/esm"
language: ts
...
- **Path:** `sokectio/socket.io-component-emitter/lib/esm`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/socket.io-component-emitter/lib/esm/index.d.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io-component-emitter/lib/esm`.
