...
repo: vortech
package_name: "@vortech/v-ui"
package_path: "platform/v-ui"
language: ts
...
**Evidencia:**
- `platform/v-ui/src/browser/broadcast.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/v-ui`.
