...
repo: vortech
package_name: "@socket.io/component-emitter"
package_path: "sokectio/socket.io-component-emitter/lib/cjs"
language: ts
...
## 1. Identidad
- **Nombre:** @socket.io/component-emitter
- **Path:** `sokectio/socket.io-component-emitter/lib/cjs`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/socket.io-component-emitter/lib/cjs/index.d.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io-component-emitter/lib/cjs`.
