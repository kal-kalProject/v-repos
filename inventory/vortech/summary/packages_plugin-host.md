...
repo: vortech
package_name: "@vortech/plugin-host"
package_path: "packages/plugin-host"
language: ts
...
**Evidencia:**
- `packages/plugin-host/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/plugin-host`.
