...
repo: vortech
package_name: "@vortech/template-demo"
package_path: "packages/template-demo"
language: ts
...
# @vortech/template-demo

## 1. Identidad
- **Nombre:** @vortech/template-demo
- **Path:** `packages/template-demo`
- **Lenguaje:** ts
...
**Evidencia:**
- `packages/template-demo/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/template-demo`.
