...
## 1. Identidad
- **Nombre:** @vortech/ai-server
- **Path:** `packages/ai-server`
- **Lenguaje:** ts
...
**Evidencia:**
- `packages/ai-server/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/ai-server`.
