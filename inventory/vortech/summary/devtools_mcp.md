...
repo: vortech
package_name: "@vortech/mcp"
package_path: "devtools/mcp"
language: ts
...
**Evidencia:**
- `devtools/mcp/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `devtools/mcp`.
