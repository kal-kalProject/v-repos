...
repo: vortech
package_name: "@vortech-connections/shared"
package_path: "connections/shared"
language: ts
...
# @vortech-connections/shared

## 1. Identidad
- **Nombre:** @vortech-connections/shared
- **Path:** `connections/shared`
- **Lenguaje:** ts
...
**Evidencia:**
- `connections/shared/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `connections/shared`.
