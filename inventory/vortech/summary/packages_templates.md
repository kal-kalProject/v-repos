...
repo: vortech
package_name: "@vortech/templates"
package_path: "packages/templates"
language: ts
...
**Evidencia:**
- `packages/templates/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/templates`.
