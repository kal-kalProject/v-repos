...
repo: vortech
package_name: "v-studio"
package_path: "packages/v-studio"
language: angular
...
**Evidencia:**
- `packages/v-studio/src/main.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/v-studio`.
