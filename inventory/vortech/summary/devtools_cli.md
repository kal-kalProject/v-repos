...
repo: vortech
package_name: "@vortech/cli"
package_path: "devtools/cli"
language: ts
...
**Evidencia:**
- `devtools/cli/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `devtools/cli`.
