...
package_path: "packages/angular-demo"
language: angular
...
**Evidencia:**
- `packages/angular-demo/src/main.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/angular-demo`.
