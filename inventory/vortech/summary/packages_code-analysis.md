...
repo: vortech
package_name: "@vortech/code-analysis"
package_path: "packages/code-analysis"
language: ts
...
# @vortech/code-analysis

## 1. Identidad
- **Nombre:** @vortech/code-analysis
...
**Evidencia:**
- `packages/code-analysis/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/code-analysis`.
