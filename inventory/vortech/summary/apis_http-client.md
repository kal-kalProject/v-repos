...
repo: vortech
package_name: "@vortech/http-client"
package_path: "apis/http-client"
language: ts
...
## 1. Identidad
- **Nombre:** @vortech/http-client
- **Path:** `apis/http-client`
- **Lenguaje:** ts
...
**Evidencia:**
- `apis/http-client/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `apis/http-client`.
