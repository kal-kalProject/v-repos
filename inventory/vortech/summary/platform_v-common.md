...
repo: vortech
package_name: "v-common"
package_path: "platform/v-common"
language: ts
...
**Evidencia:**
- `platform/v-common/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/v-common`.
