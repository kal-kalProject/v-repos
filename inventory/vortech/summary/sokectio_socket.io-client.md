...
repo: vortech
package_name: "socket.io-client"
package_path: "sokectio/socket.io-client"
language: ts
...
- **Path:** `sokectio/socket.io-client`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/socket.io-client/lib/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io-client`.
