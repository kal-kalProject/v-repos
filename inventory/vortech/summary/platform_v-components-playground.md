...
repo: vortech
package_name: "v-components-playground"
package_path: "platform/v-components-playground"
language: ts
...
# v-components-playground

## 1. Identidad
- **Nombre:** v-components-playground
- **Path:** `platform/v-components-playground`
- **Lenguaje:** ts
...
**Evidencia:**
- `platform/v-components-playground/src/main.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/v-components-playground`.
