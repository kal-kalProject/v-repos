...
repo: vortech
package_name: "esm-import"
package_path: "sokectio/engine.io/examples/esm-import"
language: ts
...
## 1. Identidad
- **Nombre:** esm-import
- **Path:** `sokectio/engine.io/examples/esm-import`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/engine.io/examples/esm-import: (sin archivo fuente típico)` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/engine.io/examples/esm-import`.
