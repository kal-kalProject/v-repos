...
repo: vortech
package_name: "socket.io-adapter"
package_path: "sokectio/socket.io-adapter"
language: ts
...
## 1. Identidad
- **Nombre:** socket.io-adapter
- **Path:** `sokectio/socket.io-adapter`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/socket.io-adapter/lib/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io-adapter`.
