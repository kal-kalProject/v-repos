...
repo: vortech
package_name: "@vortech/lsp"
package_path: "platform/v-lsp"
language: ts
...
**Evidencia:**
- `platform/v-lsp/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/v-lsp`.
