...
repo: vortech
package_name: "v-collections"
package_path: "platform/v-collections"
language: ts
...
## 1. Identidad
- **Nombre:** v-collections
- **Path:** `platform/v-collections`
- **Lenguaje:** ts
...
**Evidencia:**
- `platform/v-collections/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/v-collections`.
