...
repo: vortech
package_name: "eio-latency"
package_path: "sokectio/engine.io/examples/latency"
language: ts
...
## 1. Identidad
- **Nombre:** eio-latency
- **Path:** `sokectio/engine.io/examples/latency`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/engine.io/examples/latency: (sin archivo fuente típico)` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/engine.io/examples/latency`.
