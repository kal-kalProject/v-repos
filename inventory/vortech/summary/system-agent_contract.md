...
repo: vortech
package_name: "@system-agent/contract"
package_path: "system-agent/contract"
language: ts
...
## 1. Identidad
- **Nombre:** @system-agent/contract
- **Path:** `system-agent/contract`
- **Lenguaje:** ts
...
**Evidencia:**
- `system-agent/contract/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `system-agent/contract`.
