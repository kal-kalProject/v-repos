...
repo: vortech
package_name: "@socket.io/cluster-adapter"
package_path: "sokectio/socket.io-cluster-adapter"
language: ts
...
## 1. Identidad
- **Nombre:** @socket.io/cluster-adapter
- **Path:** `sokectio/socket.io-cluster-adapter`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/socket.io-cluster-adapter/lib/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io-cluster-adapter`.
