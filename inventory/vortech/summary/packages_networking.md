...
repo: vortech
package_name: "@vortech/networking"
package_path: "packages/networking"
language: ts
...
**Evidencia:**
- `packages/networking/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/networking`.
