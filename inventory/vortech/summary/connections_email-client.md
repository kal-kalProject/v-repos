...
repo: vortech
package_name: "@vortech/email-client"
package_path: "connections/email-client"
language: ts
...
# @vortech/email-client

## 1. Identidad
- **Nombre:** @vortech/email-client
- **Path:** `connections/email-client`
- **Lenguaje:** ts
...
**Evidencia:**
- `connections/email-client/src/email-client-provider.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `connections/email-client`.
