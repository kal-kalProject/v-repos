...
package_path: "sokectio/engine.io"
language: ts
...
**Evidencia:**
- `sokectio/engine.io/lib/contrib/types.cookie.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/engine.io`.
