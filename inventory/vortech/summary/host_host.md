...
repo: vortech
package_name: "@vortech/extensions-host"
package_path: "host/host"
language: ts
...
# @vortech/extensions-host

## 1. Identidad
- **Nombre:** @vortech/extensions-host
- **Path:** `host/host`
- **Lenguaje:** ts
...
**Evidencia:**
- `host/host/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `host/host`.
