...
repo: vortech
package_name: "@vortech-connections/google"
package_path: "connections/google"
language: ts
...
# @vortech-connections/google

## 1. Identidad
- **Nombre:** @vortech-connections/google
...
**Evidencia:**
- `connections/google/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `connections/google`.
