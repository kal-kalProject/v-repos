...
**Evidencia:**
- `platform/core/.generated/globals.d.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/core`.
