...
package_path: "devtools/dev-server"
language: ts
...
**Evidencia:**
- `devtools/dev-server/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `devtools/dev-server`.
