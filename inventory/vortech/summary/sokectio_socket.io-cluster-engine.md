...
repo: vortech
package_name: "@socket.io/cluster-engine"
package_path: "sokectio/socket.io-cluster-engine"
language: ts
...
## 1. Identidad
- **Nombre:** @socket.io/cluster-engine
- **Path:** `sokectio/socket.io-cluster-engine`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/socket.io-cluster-engine/lib/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io-cluster-engine`.
