...
repo: vortech
package_name: "v-components"
package_path: "platform/v-components"
language: ts
...
**Evidencia:**
- `platform/v-components/src/decorators/component.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/v-components`.
