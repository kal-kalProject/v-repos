...
repo: vortech
package_name: "memory-usage-webtransport"
package_path: "sokectio/engine.io/examples/memory-usage-webtransport"
language: ts
...
## 1. Identidad
- **Nombre:** memory-usage-webtransport
- **Path:** `sokectio/engine.io/examples/memory-usage-webtransport`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/engine.io/examples/memory-usage-webtransport: (sin archivo fuente típico)` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/engine.io/examples/memory-usage-webtransport`.
