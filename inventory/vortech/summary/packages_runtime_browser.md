...
repo: vortech
package_name: "@vortech/browser"
package_path: "packages/runtime/browser"
language: ts
...
## 1. Identidad
- **Nombre:** @vortech/browser
- **Path:** `packages/runtime/browser`
- **Lenguaje:** ts
...
**Evidencia:**
- `packages/runtime/browser/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/runtime/browser`.
