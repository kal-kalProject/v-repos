...
repo: vortech
package_name: "@vortech/application-host"
package_path: "host/application-host"
language: ts
...
# @vortech/application-host

## 1. Identidad
- **Nombre:** @vortech/application-host
- **Path:** `host/application-host`
- **Lenguaje:** ts
...
**Evidencia:**
- `host/application-host/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `host/application-host`.
