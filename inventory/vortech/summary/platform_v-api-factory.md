...
repo: vortech
package_name: "v-api-factory"
package_path: "platform/v-api-factory"
language: ts
...
## 1. Identidad
- **Nombre:** v-api-factory
- **Path:** `platform/v-api-factory`
- **Lenguaje:** ts
...
**Evidencia:**
- `platform/v-api-factory/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/v-api-factory`.
