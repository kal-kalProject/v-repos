...
package_path: "sokectio/socket.io"
language: ts
...
**Evidencia:**
- `sokectio/socket.io/lib/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io`.
