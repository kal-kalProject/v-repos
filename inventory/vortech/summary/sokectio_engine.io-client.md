...
package_path: "sokectio/engine.io-client"
language: ts
...
## 1. Identidad
- **Nombre:** engine.io-client
- **Path:** `sokectio/engine.io-client`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/engine.io-client/lib/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/engine.io-client`.
