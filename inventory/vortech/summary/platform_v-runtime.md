...
repo: vortech
package_name: "v-runtime"
package_path: "platform/v-runtime"
language: ts
...
**Evidencia:**
- `platform/v-runtime/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/v-runtime`.
