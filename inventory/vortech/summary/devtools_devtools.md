...
package_path: "devtools/devtools"
language: ts
...
**Evidencia:**
- `devtools/devtools/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `devtools/devtools`.
