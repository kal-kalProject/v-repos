...
repo: vortech
package_name: "@vortech-connections/calendar"
package_path: "connections/calendar"
language: ts
...
# @vortech-connections/calendar

## 1. Identidad
- **Nombre:** @vortech-connections/calendar
...
**Evidencia:**
- `connections/calendar/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `connections/calendar`.
