...
repo: vortech
package_name: "@vortech/plugin-sdk"
package_path: "packages/plugin-sdk"
language: ts
...
**Evidencia:**
- `packages/plugin-sdk/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/plugin-sdk`.
