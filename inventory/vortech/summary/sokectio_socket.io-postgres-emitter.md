...
repo: vortech
package_name: "@socket.io/postgres-emitter"
package_path: "sokectio/socket.io-postgres-emitter"
language: ts
...
## 1. Identidad
- **Nombre:** @socket.io/postgres-emitter
- **Path:** `sokectio/socket.io-postgres-emitter`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/socket.io-postgres-emitter/lib/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io-postgres-emitter`.
