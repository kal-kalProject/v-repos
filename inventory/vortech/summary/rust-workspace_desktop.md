...
repo: vortech
package_name: "v-desk"
package_path: "rust-workspace/desktop"
language: rust
manifest: Cargo.toml
...
**Evidencia:**
- `rust-workspace/desktop/src/main.rs:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `rust-workspace/desktop`.
