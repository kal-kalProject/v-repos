...
package_path: "sokectio/socket.io-component-emitter"
language: ts
...
- **Path:** `sokectio/socket.io-component-emitter`
- **Lenguaje:** ts
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io-component-emitter`.
