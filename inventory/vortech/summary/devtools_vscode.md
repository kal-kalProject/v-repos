...
repo: vortech
package_name: "vortech-platform-vscode"
package_path: "devtools/vscode"
language: ts
...
# vortech-platform-vscode

## 1. Identidad
- **Nombre:** vortech-platform-vscode
...
**Evidencia:**
- `devtools/vscode/src/core/diagnostics-adapter.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `devtools/vscode`.
