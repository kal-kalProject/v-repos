...
package_path: "sokectio/engine.io-parser"
language: ts
...
## 1. Identidad
- **Nombre:** engine.io-parser
- **Path:** `sokectio/engine.io-parser`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/engine.io-parser/lib/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/engine.io-parser`.
