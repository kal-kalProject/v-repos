...
repo: vortech
package_name: "di-demo"
package_path: "platform/di-demo"
language: ts
...
**Evidencia:**
- `platform/di-demo/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/di-demo`.
