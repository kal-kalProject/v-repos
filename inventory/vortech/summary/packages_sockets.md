...
repo: vortech
package_name: "@vortech/sockets"
package_path: "packages/sockets"
language: ts
...
## 1. Identidad
- **Nombre:** @vortech/sockets
- **Path:** `packages/sockets`
- **Lenguaje:** ts
...
**Evidencia:**
- `packages/sockets/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/sockets`.
