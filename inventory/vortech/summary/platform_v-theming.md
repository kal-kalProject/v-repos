...
repo: vortech
package_name: "v-theming"
package_path: "platform/v-theming"
language: ts
...
**Evidencia:**
- `platform/v-theming/src/css/cn.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/v-theming`.
