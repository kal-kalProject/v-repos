...
repo: vortech
package_name: "@vortech/layout-demo"
package_path: "platform/sdk/demo"
language: ts
...
## 1. Identidad
- **Nombre:** @vortech/layout-demo
- **Path:** `platform/sdk/demo`
- **Lenguaje:** ts
...
**Evidencia:**
- `platform/sdk/demo/src/main.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/sdk/demo`.
