...
repo: vortech
package_name: "@vortech/translation"
package_path: "packages/translation"
language: ts
...
**Evidencia:**
- `packages/translation/src/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/translation`.
