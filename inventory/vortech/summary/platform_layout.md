...
repo: vortech
package_name: "@vortech/layout"
package_path: "platform/layout"
language: ts
...
**Evidencia:**
- `platform/layout/src/common/arrays.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `platform/layout`.
