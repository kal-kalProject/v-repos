...
repo: vortech
package_name: "virtual-screens-quest"
package_path: "metaquest/quest-app"
language: ts
...
# virtual-screens-quest

## 1. Identidad
- **Nombre:** virtual-screens-quest
- **Path:** `metaquest/quest-app`
- **Lenguaje:** ts
...
**Evidencia:**
- `metaquest/quest-app/src/main.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `metaquest/quest-app`.
