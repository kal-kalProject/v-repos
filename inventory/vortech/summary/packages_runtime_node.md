...
repo: vortech
package_name: "@vortech/node"
package_path: "packages/runtime/node"
language: ts
...
**Evidencia:**
- `packages/runtime/node/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `packages/runtime/node`.
