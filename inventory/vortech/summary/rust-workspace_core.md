...
repo: vortech
package_name: "v-core"
package_path: "rust-workspace/core"
language: rust
manifest: Cargo.toml
...
**Evidencia:**
- `rust-workspace/core/src/wire/common/event.rs:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `rust-workspace/core`.
