...
package_path: "sokectio/socket.io-parser"
language: ts
...
## 1. Identidad
- **Nombre:** socket.io-parser
- **Path:** `sokectio/socket.io-parser`
- **Lenguaje:** ts
...
**Evidencia:**
- `sokectio/socket.io-parser/lib/index.ts:1` — primer fuente local bajo el path (heurística Fase 1).
...
- Inspeccionar subcarpetas `src/`, `lib/`, `tests/` bajo `sokectio/socket.io-parser`.
